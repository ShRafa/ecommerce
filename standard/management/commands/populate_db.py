...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not Product.objects.all().exists():
            ...
            source_code.image.save(
                "source_code.jpeg", open("static/images/source_code.jpeg", "rb")
            )
            ...
            necklace.image.save(
                "necklace.jpeg", open("static/images/necklace.jpeg", "rb")
            )
            ...
            airplane_passage.image.save(
                "airplane_passage.jpeg",
                open("static/images/airplane_passage.jpeg", "rb"),
            )
            ...
            self.stdout.write(self.style.SUCCESS("Loja carregada com sucesso :"))
